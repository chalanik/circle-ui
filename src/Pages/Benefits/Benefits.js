      ...
      <div className="benefits-wrapper-container">
        <div className="benefits-container">
          <div className="benefits-title">
            {" "}
            The firm is pleased to offer you the following benefits{" "}
          </div>
          <div className="benefits-card-container">
            ...
            <BenefitsCard
              className="benefits-card-items"
              image="./benefits1.png"
              title="529 Plans and More: Innovative and Effective Ways to Pay for Education"
              text="A 529 plan is a great way to invest for future education costs, but there are also other options to raise the funds you need."
            />
            <BenefitsCard
              className="benefits-card-items"
              image="./benefits2.png"
