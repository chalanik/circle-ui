...
function Dependents() {
  ...
  return (
    <>
      <Header title="Join Circle" user={user} progress={50} />
      <div className="user-info-container">
        ...
        <div className="dependents-info-container">
          <div className="dependents-age-dropdown">
            ...
            <Select className="dependent-age-select" value="">
        ...
        <div className="navigation-container">
          <div className="dependent-back-link">
            <Link className="back-link" to="/user-info">
              Back
            </Link>
          </div>
